...
import { FaUser, FaLock, FaEnvelope, FaStore, FaSpinner } from 'react-icons/fa';
...
const VendorSignup = () => {
  ...
  const fields = [
    { name: 'name', label: 'Your Name', icon: FaUser, type: 'text', placeholder: 'Ramesh Kumar' },
    { name: 'restaurantName', label: 'Restaurant Name', icon: FaStore, type: 'text', placeholder: 'Spice Garden' },
    { name: 'email', label: 'Email Address', icon: FaEnvelope, type: 'email', placeholder: 'you@restaurant.com' },
    { name: 'password', label: 'Password', icon: FaLock, type: 'password', placeholder: '••••••••' },
  ];
      ...
      >
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2">
            Set up your restaurant to start taking QR orders
          </p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-6">
          ...
          <Link to="/vendor/login" className="text-red-500 font-semibold hover:underline">
            Login
          </Link>
        </p>
      </motion.div>
